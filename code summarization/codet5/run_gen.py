...
from utils import get_filenames, get_elapse_time, load_and_cache_gen_data,get_filenamelist
...
def main():
    ...
    if args.do_test:
        ...
        for criteria in ['best-bleu']:
            ...
            args.train_filename, args.dev_filename, args.test_filename = get_filenamelist(args.data_dir, args.task,
                                                                                          args.sub_task)
