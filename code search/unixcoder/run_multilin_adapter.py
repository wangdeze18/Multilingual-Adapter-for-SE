            ...
            #for lang_i in language:
                ...
                with open(train_file) as f:
                    for line in f:
                        ...
                        '''
                        data.append(js)
                self.len_list.append(len(data)-len_sum)
                print(len(data)-len_sum)
                len_sum = len(data)
...
def train(args, model, tokenizer):
    ...
    for idx in range(args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            #print("for check",len(train_dataloader))
...
def main():
    ...
    delta_model = AdapterModel(backbone_model=model,
                               ...
                               bottleneck_dim=64)  # This will apply adapter to the self-attn and feed-forward layer.
